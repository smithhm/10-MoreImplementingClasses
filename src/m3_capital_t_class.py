    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        # ---------------------------------------------------------------------
        c = intersection_center
        t = letter_thickness
        w = width
        h = height
        self.v_rect = rg.Rectangle(rg.Point(c.x - (t / 2), c.y - (t / 2)), rg.Point(c.x + (t / 2), c.y + (h - (t / 2))))
        self.h_rect = rg.Rectangle(rg.Point(c.x - (w / 2), c.y - (t / 2)), rg.Point(c.x + (w / 2), c.y + (t / 2)))
    ...
    def move_by(self, dx, dy):
        ...
        self.h_rect.corner_1 = rg.Point(self.h_rect.get_upper_left_corner().x + dx, self.h_rect.get_upper_left_corner().
                                        y + dy)
        self.h_rect.corner_2 = rg.Point(self.h_rect.get_lower_right_corner().x + dx,
                                        self.h_rect.get_lower_right_corner().y + dy)
        self.v_rect.corner_1 = rg.Point(self.v_rect.get_upper_left_corner().x + dx,
                                        self.v_rect.get_upper_left_corner().y + dy)
        self.v_rect.corner_2 = rg.Point(self.v_rect.get_lower_right_corner().x + dx,
    ...
    def clone(self):
        ...
        #######################################################################
        return self.h_rect, self.v_rect
